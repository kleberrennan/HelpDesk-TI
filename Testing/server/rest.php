...
class REST {
    ...
    public function __construct() {
        ...
        file_put_contents('../debug.txt', $this->request);
    ...
    public function validateToken() {
        try {
            ...
            $payload = \Firebase\JWT\JWT::decode
                ($token, new Firebase\JWT\Key(SECRET_KEY, 'HS256'));

            $stmt = $this->dbConn->prepare("SELECT * FROM tbl_users WHERE id_user=:idUser");
